...
class Simulador:
    ...
    def crear_ui(self):
        ...
        frame_izq = tk.Frame(contenedor, bg=PANEL, width=200)
        ...
        frame_der = tk.Frame(contenedor, bg=PANEL, width=450)
        ...
        self.text_terminados = tk.Text(frame_der, bg=BG, fg=ROJO, font=("Consolas", 10))
